...
class WhatsAppSecurity:
    ...
    _HOST_SECRET_MAP = {
        ...
        'lbelivros.com.br': 'WHATSAPP_APP_SECRET_LBE',
        'lblivros.com.br': 'WHATSAPP_APP_SECRET_LB',
    ...
    _HOST_ACCESS_TOKEN_MAP = {
        ...
        'lbelivros.com.br': 'WHATSAPP_ACCESS_TOKEN_LBE',
        'lblivros.com.br': 'WHATSAPP_ACCESS_TOKEN_LB',
