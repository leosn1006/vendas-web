...
-- Produto  8: Receitas de Pudim Sem Forno que Derrete na Boca
UPDATE produtos SET isbn = '978-65-976357-0-2', nome_nfe = 'E-book Receitas de Pudim Sem Forno que Derrete na Boca'                    WHERE id = 8;
-- Produto 10: Cozinha Saudável - Controle o açúcar sem abrir mão do sabor
UPDATE produtos SET isbn = '978-65-976357-3-3', nome_nfe = 'E-book Cozinha Saudável - Controle o açúcar sem abrir mão do sabor'        WHERE id = 10;
